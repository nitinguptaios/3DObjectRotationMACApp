//
//  AddLineNodeExtension.swift
//  ThreeDPortalFilemaker
//
//  Created by iPHTech36 on 30/06/22.
//
...
extension SCNNode {
    ...
    func buildLineInTwoPointsWithRotation(from startPoint: SCNVector3, to endPoint: SCNVector3, radius: CGFloat, color: NSColor) -> SCNNode {
